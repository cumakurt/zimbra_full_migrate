...
- If the source CA file omits a root that `zmcertmgr` requires, the script completes the chain from the destination trust store and skips expired CA certificates.
